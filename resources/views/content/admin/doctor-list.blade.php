...
@section('page-style')
<style>
  /* Custom hospital-themed styling for Elitecare Hospital */
  .card {
    border-radius: 10px;
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title mb-0">Doctor List</h4>
      </div>
      <div class="card-body">
        <div class="table-responsive">
          <table id="doctor-list-table" class="appointment-table table table-striped table-hover">
            <thead>
              <tr>
                <th>Doctor ID</th>
                <th>Doctor Name</th>
...
<script>
  $(document).ready(function() {
    console.log('Route URL: ' + "{{ route('admin.doctor-list.data') }}");
    $('#doctor-list-table').DataTable({
      ...
      "ajax": {
        "url": "{{ route('admin.doctor-list.data') }}",
        "type": "POST",
        "data": function(d) {
          d._token = "{{ csrf_token() }}";
