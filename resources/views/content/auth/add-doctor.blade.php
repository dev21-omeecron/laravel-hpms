...
@section('title', 'Doctor Register Page')
  ...
  <div class="auth-inner row m-0">
    ...
    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
      <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
        <h2 class="card-title fw-bold mb-1">Doctor Registration</h2>
        <p class="card-text mb-2">Make your app management easy and fun!</p>
        <form class="auth-add-doctor-form mt-2" action="{{ route('add-doctor') }}" method="POST">

          @csrf
          <div class="mb-1">
            <label class="form-label" for="register-docname">Doctor Name</label>
            <input class="form-control" id="register-docname" type="text" name="docname" placeholder="johndoe" aria-describedby="register-docname" autofocus="" tabindex="1" />
          </div>
          <div class="mb-1">
          ...
          <div class="mb-1">
            <label class="form-label" for="register-specialization">Doctor Specialization</label>
            <select class="form-select" id="register-specialization" name="spec" aria-describedby="register-specialization" tabindex="1">
          ...
          <div class="mb-1">
            <label class="form-label" for="register-doctorfees">Doctor Fees</label>
            <input class="form-control" id="register-doctorfees" type="text" name="docFees" placeholder="" aria-describedby="register-doctorfees" autofocus="" tabindex="1" />
          </div>
          <div class="mb-1">
...
<script>
  $(document).ready(function() {
    $(".auth-add-doctor-form").submit(function(event) {
